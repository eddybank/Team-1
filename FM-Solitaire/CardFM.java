...
class CardFM extends JPanel
{
	...
	CardFM()
	{
		_suit = CardFM.Suit.CLUBS;
		_value = CardFM.Value.ACE;
		_faceup = false;
		_location = new Point();
		x = 0;
		y = 0;
	...
	public CardFM setFaceup()
	{
		_faceup = true;
		return this;
	}

	public CardFM setFacedown()
	{
		_faceup = false;
		return this;
	}
	...
	{
		Rectangle rect = new Rectangle(whereAmI.x, whereAmI.y, CardFM.CARD_WIDTH, CardFM.CARD_HEIGHT);
