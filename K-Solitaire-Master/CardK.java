...
class CardK extends JPanel
{
	...
	CardK()
	{
		_suit = CardK.Suit.CLUBS;
		_value = CardK.Value.ACE;
		_faceup = false;
		_location = new Point();
		x = 0;
		y = 0;
	...
	public CardK setFaceup()
	{
		_faceup = true;
		return this;
	}

	public CardK setFacedown()
	{
		_faceup = false;
		return this;
	}
	...
	{
		Rectangle rect = new Rectangle(whereAmI.x, whereAmI.y, CardK.CARD_WIDTH, CardK.CARD_HEIGHT);
